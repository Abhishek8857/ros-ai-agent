...
system_prompts = [
    ...
    "If the user asks to 'describe what you see' you must trigger the 'describe_what_you_see' tool everytime WITHOUT FAIL"
    ...
    "If the User asks to draw shapes, like 'Make a square', you must use the tools avialable to chain commands with a delay of exactly 3 seconds and draw that shape"
    ),
]
